...
import { Wind, DropletFill, Hurricane, BodyText, CloudFill } from 'react-bootstrap-icons';
...
const CurrentWeather = ({ weatherData }) => {
    ...
    const RenderInfo = () => {
        ...
        const { temp_c, wind_kph, humidity, feelslike_c, pressure_mb, condition } = current;
        ...
        return (
            <div className='font-montserrat flex justify-between w-full mt-6 rounded-xl p-4 bg-white bg-opacity-80 backdrop-blur-md'>
                ...
                <div className='flex-1'>
                    ...
                    <div className='ml-2 -mt-5 font-semibold text-slate-500'>
                        {text}
                    </div>
                </div>
                ...
                <div className='flex flex-col justify-center text-start capitalize flex-1 ml-14'>
                    ...
                    <p className='flex items-center gap-x-5'>
                        <BodyText />
                        <span>feels like  </span>{feelslike_c} &deg;
                    </p>
                    ...
                    <p className='flex items-center gap-x-5'>
                        <Wind />
                        <span className='mr-7'>wind  </span>{wind_kph}kph
                    </p>

                    <p className='flex items-center gap-x-5'>
                        <Hurricane />
                        <span>pressure  </span>{pressure_mb}mb
                    </p>
